...
extension Color {
    static let kaleidigoAccent = Color(red: 0x01 / 255.0, green: 0xC7 / 255.0, blue: 0xFC / 255.0)
    
    static let darkIndigo = Color(red: 0x2A / 255.0, green: 0x0E / 255.0, blue: 0x5C / 255.0)
    
    static let kaleidigoOrange = Color(red: 0xFF / 255.0, green: 0x6A / 255.0, blue: 0x00 / 255.0)
    
    static let kaleidigoYellow = Color(red: 0xFF / 255.0, green: 0xF9 / 255.0, blue: 0x94 / 255.0)
